...
import org.tony.springframework.study.validator.asserttruevalidator.Singer;
import org.tony.springframework.study.validator.asserttruevalidator.SingerCusAssertValidattionService;
 ...
 */
public class Jsr349CusAssertValidatorTest {

    private static final Logger LOGGER = LoggerFactory.getLogger(Jsr349CusAssertValidatorTest.class);
    ...
    public void testCustomerValidator(){
        SingerCusAssertValidattionService singerValidattionService =
                genericApplicationContext.getBean(SingerCusAssertValidattionService.class);
    ...
    private void validateSinger(Singer singer, SingerCusAssertValidattionService singerValidattionService) {
